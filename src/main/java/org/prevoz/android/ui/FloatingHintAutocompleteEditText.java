...
/**
 * Floating hint edit text, courtesy of thebnich
 *
...
public class FloatingHintAutocompleteEditText extends AutoCompleteTextView
{
    ...
    public FloatingHintAutocompleteEditText(Context context, AttributeSet attrs)
    {
        this(context, attrs, R.attr.floatingHintEditTextStyle);
    }

    public FloatingHintAutocompleteEditText(Context context, AttributeSet attrs, int defStyle)
    {
