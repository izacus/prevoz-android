...
public class DeviceAccountLogin implements AccountManagerCallback<Bundle>
{
    ...
    public DeviceAccountLogin(LoginActivity activity, WebView view)
    {
        mActivity = activity;
        mWebView = view;
    ...
    public void run(AccountManagerFuture<Bundle> value)
    {
        try {
            ...
            else
            {
                ...
                mActivity.setDeviceAccountLogin(null);
                mActivity.hideAutoLogin();
            }
        }
        catch (Exception e)
        {
    ...
    {
        mState = FAILED;
        if (mActivity.getDeviceAccountLogin() == null)
        {
            displayLoginUi();
        }
        else
    ...
    private void displayLoginUi()
    {
        ...
        mActivity.setDeviceAccountLogin(this);
        mActivity.showAutoLogin();
    }
